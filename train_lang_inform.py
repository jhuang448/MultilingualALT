...
class ASR(sb.core.Brain):
    def compute_forward(self, batch, stage):
        ...
        e_lang = self.modules.emb(tokens_lang)
        e_lang_exp = e_lang.repeat(1, src.shape[1], 1)
        # e_lang_exp = self.modules.normalize_lang(e_lang_exp, wav_lens, epoch=current_epoch)

        enc_out, pred, interm_out = self.modules.Transformer(
            src, tokens_bos, wav_lens, pad_idx=self.hparams.pad_index, condition_emb=e_lang_exp
        )
